...
public class RegistrationLotHandler extends AsyncTask<Void, Void, String> {
    private Context context;
    private LotCallback callback;
    private String endpoint = Constants.ENDPOINT + "register_lots.php";

    public RegistrationLotHandler(Context context, LotCallback callback) {
